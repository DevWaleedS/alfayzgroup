...
const TrackOrderForm = () => {
	...
	return (
		<section>
			<div className='w-[796px] h-[280px] flex flex-col items-start gap-8'>
				...
				<form className='w-[796px] h-[95px] flex justify-between items-center py-[20px] px-[30px] bg-bg-light'>
					<div className='w-[736px] h-[50px] flex justify-between items-center '>
						<input
							...
							className='input-ar'
						/>
						<button className='w-[112px] h-[50px] bg-primary-700 rounded-[10px] py-[13px] px-[40px] text-lg font-bold leading-[25.6px] text-bg-light transition-colors hover:bg-primary-600 hadow-custom-shadow'>
							بحث
						</button>
					</div>
				</form>
