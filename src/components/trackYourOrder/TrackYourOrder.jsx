...
const TrackYourOrder = () => {
	...
	return (
		<section className=' absolute z-[1] -bottom-[520px] left-1/2 -translate-x-1/2 w-[1200px] h-[422px] border-[7px] border-primary-700 rounded-[20px] bg-bg-light flex flex-col items-start pt-[110px] px-[50px]'>
